...
import { startingFeatures5 } from '../constants';
...
const GetStarted5 = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        <TypingText title="| Technical Events" />
        <TitleText2 title={<>Blow away the Competition with these tips</>} />
        <div className="mt-[31px] flex flex-col max-w-[370px] gap-[24px]">
          {startingFeatures5.map((feature, index) => (
            <StartSteps
              key={feature}
