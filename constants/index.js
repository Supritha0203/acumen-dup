...
export const startingFeatures4 = [
  'Attend demonstrations to learn about the current robotic technology',
  'Participate in the interactive workshop to gain hands-on experience',
  'Engage with the techie to get advice and guidance on how to get started',
  'Explore the exhibits and demos to get a sense of the diverse range of applications',
];
